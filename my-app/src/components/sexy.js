...
export class Sexy extends Component {
    constructor(props) {
        super(props)
        this.state = {
            fetched_data: false,
    ...
    getNextTask() {
        ...
        if (!numTasks) {
            let end_task = <Link to="/" style={{ textDecoration: 'none', color: 'white', fontSize: 'auto' }}><b>You naughty thing! &#128520; &#127866; &#127881;<br />One could almost think that we're related &#128521; </b></Link>
